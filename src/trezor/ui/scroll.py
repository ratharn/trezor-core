...
async def animate_swipe():
    ...
    for t in ui.pulse(draw_delay):
        fg = ui.blend(ui.GREY, ui.WHITE, t)
        ui.display.bar_radius(102, 214, 36, 4, fg, ui.C_SCREEN_BG, 2)
        ui.display.bar_radius(106, 222, 28, 4, fg, ui.C_SCREEN_BG, 2)
        ui.display.bar_radius(110, 230, 20, 4, fg, ui.C_SCREEN_BG, 2)
        await sleep
    ...
    for i in range(0, page_count):
        if i != page:
            ui.display.bar_radius(x, y + i * padding, size,
                                  size, ui.GREY, ui.C_SCREEN_BG, 4)
    ui.display.bar_radius(x, y + page * padding, size,
                          size, ui.WHITE, ui.C_SCREEN_BG, 4)
